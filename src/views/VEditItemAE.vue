        ...
        <div class="flex-content"> <!-- Grade -->
          ...
          <div class="w70">
            <select v-model="AE.Grade">
              <option value="1">1:正常な術後経過からの逸脱</option>
              <option value="2">2:中等症 &nbsp; 輸血および中心静脈栄養を要する場合を含む</option>
              <option value="3a">3a:全身麻酔を要さない治療介入を要する</option>
              <option value="3b">3b:全身麻酔下での治療介入を要する</option>
              <option value="4">4:ICU管理を要する、合併症により生命を脅かす状態</option>
