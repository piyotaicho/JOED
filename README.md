...
## 変更履歴
- 2026-04-07 Windows環境での上書きインストールとキャッシュの不整合に起因する書き出しの動作不良を回避する為、インストーラーを修正.
- 2026-03-06 [2.0.2256] インポートのレコードタイプ判定とアプローチ法のインポートを修正. JSONエクスポートにも選択レコードの出力を追加.
- 2026-02-03 [2.0.2225] 準広汎子宮全摘術の重複チェックの問題を修正.
- 2026-01-25 [2.0.2216]一時保存要件の修正. 付属器切除関連の制限を緩和.
- 2026-01-07 バージョン2.0マニュアルをリリース.
